...
(function (manager) {
    ...
    function modifyIndex(manifestPath, indexPath) {
        //todo
        // if (!ProjectData_1.data.useTemplate) {
            console.log("ProjectManager modifyIndex1");
            ...
            var gameStr = "";
            console.log("ProjectManager modifyIndex2:",manifest.game);
            game.forEach(function (m) {
                gameStr += getScript("lib", m);
            });
            console.log("ProjectManager modifyIndex3:",gameStr);
            ...
            var replaceStr = '';
            htmlContent = htmlContent.replace(reg, replaceStr);
            console.log("ProjectManager modifyIndex4 htmlContent:",htmlContent);
