...
var CompileProject = (function () {
    ...
    CompileProject.prototype.compile = function (options) {
        console.log("----CompileProject.compile----options:",options)
    ...
    //todo modify
    CompileProject.prototype.sortFiles = function (args, files) {
        console.warn("----CompileProject.sortFiles----");
        console.log("files:",files,"this.compilerHost:",this.compilerHost);
        if (files && this.compilerHost) {
            ...
            console.log("CompileProject compileProject",fileNames);
            ...
            this.compilerHost = compiler.prepareSortFiles(this.compilerOptions, fileNames);
        }
    ...
    CompileProject.prototype.compileProject = function (args, files) {
        console.warn("----CompileProject.compileProject----");
        console.log("files:",files,"this.compilerHost:",this.compilerHost);
        if (files && this.compilerHost) {
            // files.forEach(f => f.fileName = f.fileName.replace(args.projectDir, ""));
            // var realCWD = process.cwd();
